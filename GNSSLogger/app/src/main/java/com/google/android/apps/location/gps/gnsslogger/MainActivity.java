...
public class MainActivity extends AppCompatActivity
    ...
    private static final int FRAGMENT_INDEX_TOGGLESENSER = 6; //센서 뷰 추가
...
//
    ...
    public class ViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                ...
                case FRAGMENT_INDEX_TOGGLESENSER:
                    return mFragments[FRAGMENT_INDEX_TOGGLESENSER];
                default:
        ...
        public CharSequence getPageTitle(int position) {
            ...
            switch (position) {
                ...
                case FRAGMENT_INDEX_TOGGLESENSER:
                    return getString(R.string.title_togglesenser).toLowerCase(locale);
                default:
    ...
    private void setupFragments() {
        ...
        ToggleFragment toggleFragment = new ToggleFragment(getBaseContext());
        mFragments[FRAGMENT_INDEX_TOGGLESENSER] = toggleFragment;
